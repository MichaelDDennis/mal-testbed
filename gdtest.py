...
from agents import GradientDescentBasedAgent, TransparentAgentDecorator, SamplingAgentDecorator, NameAgentDecorator
...
def main():
    ...
    with tf.Session() as session:
        ...
        initial_state = {'last_action_a': {'action': 0.0, 'model': initial_model_agent_a},
                         'last_action_b': {'action': 0.0, 'model': initial_model_agent_b}}
